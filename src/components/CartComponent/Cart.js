      ...
      {cartItems.length === 0 ? (
        ...
        <>
              ...
              {cartItems.map((item, index) => (
                <li className="cart-item">
                  ...
                  <div className="cart-item-qty">
                    {item.quantity > 1 ? (
                      <span onClick={() => dispatch(decreaseItem(item))}>
                    ...
                    <span onClick={() => dispatch(increaseItem(item))}>
                      <FontAwesomeIcon icon={["fas", "plus"]} />
                    </span>
                  </div>
                  <div className="cart-item-price">
                    {parseInt(item.price.substring(1)) * item.quantity}
                  </div>
                </li>
              ))}
            </ul>
          ...
          <div className="cart-checkout-button">
            <button onClick={() => dispatch(clearItemsFromCart())}>
              Clear Cart
            </button>
          </div>
          ...
          <div className="cart-checkout">
            ...
            <div className="cart-total">
              <h4>Total :</h4>
              <span>{cartTotalAmount && cartTotalAmount} </span>
            </div>
